...
export const metadata: Metadata = {
  title: "Sadbhavna Laser Piles Hospital Ahmedabad | Dr. Rakesh Sanol",  description: "Advanced laser & laparoscopic surgery for piles, fissure, fistula, hernia in Ahmedabad. 20+ years experience, 11,000+ surgeries. Free consultation, cashless insurance, EMI available.",  keywords: "piles doctor Ahmedabad, laser piles surgery, fissure treatment, hernia surgery, Dr. Rakesh Sanol, best surgeon Gujarat",  metadataBase: new URL("https://sadbhavnahospital.com"),
  alternates: {
    canonical: "https://sadbhavnahospital.com"},
  openGraph: {
    title: "Sadbhavna Laser Piles Hospital - Expert Surgical Care",    description: "Trusted laser surgery center in Ahmedabad offering advanced treatment for piles, fissures, fistulas, and hernias with 20+ years experience.",    url: "https://sadbhavnahospital.com",    siteName: "Sadbhavna Hospital",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/medical-ventilator-being-monitored-by-anaesthetist-surgeon-using-monitor-operating-room_657921-1089.jpg",        alt: "Advanced Laser Surgery at Sadbhavna Hospital"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Sadbhavna Laser Piles Hospital - Best Surgical Care",    description: "Advanced laser surgery for piles, fissures, hernias. Expert surgeon Dr. Rakesh Sanol. Free consultation available.",    images: ["http://img.b2bpic.net/free-photo/medical-ventilator-being-monitored-by-anaesthetist-surgeon-using-monitor-operating-room_657921-1089.jpg"],
  },
  robots: {
    index: true,
    follow: true,
